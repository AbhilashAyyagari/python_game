...
class Alien(Sprite):
    ...
    def __init__(self, game_req , game ):
        ...
        self.image = pygame.image.load("images/1c4ea9a14de5e9eebb04387d1e9f54ec-removebg-preview.png")
...
class ship_struct(Sprite):
    def __init__(self , game , game_req):
        ...
        self.image = pygame.image.load("istockphoto-1128766183-612x612-removebg-preview.png")
